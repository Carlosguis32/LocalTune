...
async function getAllPlaylists() {
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Repositories$2f$Melira$2f$tauri$2d$migration$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/v1/playlists`);
    if (!response.ok) {
...
async function getPlaylistById(playlistId) {
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Repositories$2f$Melira$2f$tauri$2d$migration$2f$lib$2f$constants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/v1/playlist/${playlistId}`);
    if (!response.ok) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6070b6c4._.js.map