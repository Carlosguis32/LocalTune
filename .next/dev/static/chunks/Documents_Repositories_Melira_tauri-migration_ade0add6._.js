...
async function getAllPlaylists() {
    try {
        const playlists = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Repositories$2f$Melira$2f$tauri$2d$migration$2f$node_modules$2f40$tauri$2d$apps$2f$api$2f$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invoke"])('get_all_playlists');
        return playlists;
    } catch (error) {
...
async function getPlaylistById(playlistId) {
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Repositories$2f$Melira$2f$tauri$2d$migration$2f$node_modules$2f40$tauri$2d$apps$2f$api$2f$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invoke"])('get_playlist_by_id', {
            id: playlistId
        });
...
async function getSpotifySettings() {
    try {
        const settings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Repositories$2f$Melira$2f$tauri$2d$migration$2f$node_modules$2f40$tauri$2d$apps$2f$api$2f$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invoke"])('get_spotify_settings');
        return settings;
    } catch (error) {
...
async function saveSpotifySettings(data) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Repositories$2f$Melira$2f$tauri$2d$migration$2f$node_modules$2f40$tauri$2d$apps$2f$api$2f$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invoke"])('save_spotify_settings', {
...
async function exchangeToken(code, codeVerifier) {
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Repositories$2f$Melira$2f$tauri$2d$migration$2f$node_modules$2f40$tauri$2d$apps$2f$api$2f$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invoke"])('exchange_spotify_code', {
            code,
            codeVerifier
        });
...
async function refreshToken() {
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Repositories$2f$Melira$2f$tauri$2d$migration$2f$node_modules$2f40$tauri$2d$apps$2f$api$2f$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invoke"])('refresh_spotify_token');
        return {
            accessToken: result.access_token,
            expiresAt: result.expires_at
        };
...
async function logoutSpotify() {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Repositories$2f$Melira$2f$tauri$2d$migration$2f$node_modules$2f40$tauri$2d$apps$2f$api$2f$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invoke"])('logout_spotify');
    } catch (error) {
...
//# sourceMappingURL=Documents_Repositories_Melira_tauri-migration_ade0add6._.js.map